                  ...
                  {growthTrend.length > 0 ? (
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={growthTrend} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                        ...
                        <RechartsTooltip content={<CustomTooltip chartType="growth" />} cursor={{ stroke: isDark ? '#2D3344' : '#E5E7EB', strokeWidth: 2 }} />
                  ...
                  {departmentDistribution.length > 0 ? (
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={departmentDistribution} layout="vertical" margin={{ top: 10, right: 20, left: 10, bottom: 0 }}>
                        ...
                        <RechartsTooltip content={<CustomTooltip chartType="department" />} cursor={{ fill: isDark ? 'rgba(255,255,255,0.06)' : '#F9FAFB' }} />
